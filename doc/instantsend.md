...
This mechanism has been integrated into Bitcore-Node-Versus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/versuscoin/insight-api-versus#web-socket-api](https://github.com/versuscoin/insight-api-versus#web-socket-api) 
* API: [https://github.com/versuscoin/insight-api-versus#instantsend-transactions](https://github.com/versuscoin/insight-api-versus#instantsend-transactions) 
...
By default, the Versus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Versus Core daemon:
