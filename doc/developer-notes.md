...
Versus Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Versus Core, where everyone uses
...
pay attention to for reviewers of Versus Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Versus Core uses tinyformat, which is type safe. Leave them out to avoid confusion
