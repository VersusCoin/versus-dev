...
Only requiring some minor changes is versus.cpp.
...
Changes to versus.cpp
----------------------
versus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
