...
[From the versus github repo](https://github.com/versuscoin/versus/blob/master/doc/masternode_conf.md)
...
## What about the versus.conf file?

If you are using a `masternode.conf` file you no longer need the `versus.conf` file. The exception is if you need custom settings (_thanks oblox_). In that case you **must** remove `masternode=1` from local `versus.conf` file. This option should be used only to start local Hot masternode now.

## Update versus.conf on server

If you generated a new masternode private key, you will need to update the remote `versus.conf` files.

Shut down the daemon and then edit the file.

```nano .versuscore/versus.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `versus.conf` file.
...
and comparing with the official explorer at https://explorer.versus.org/chain/Versus
...
Search your Masternodes on https://versusninja.pl/masternodes.html
