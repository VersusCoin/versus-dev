    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Versus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Versus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and versus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Versus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Versus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Versus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Versus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Versus addresses"));
    ...
    openAction->setStatusTip(tr("Open a versus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Versus Core help message to get a list with possible Versus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Versus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Versus network", "", count));
}
...
{
    QString strTitle = tr("Versus Core"); // default title
