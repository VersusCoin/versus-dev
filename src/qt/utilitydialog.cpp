    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Versus Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Versus Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  versus-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Versus in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://versuscoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://versuscoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Versus Core is shutting down...") + "<br /><br />" +
