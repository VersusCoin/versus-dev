...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "VersusNetwork") type = VersusNetwork;
    if(strType == "VersusNetworkVariable") type = VersusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == VersusNetwork) s = "VersusNetwork";
    if(type == VersusNetworkVariable) s = "VersusNetworkVariable";
