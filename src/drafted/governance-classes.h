 ...
 *
 *   // network
 *   CVersusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.versus.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CVersusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: VersusNetwork
// //   -- signature requirements : Key1(User)
// class CVersusNetworkVariable : public CGovernanceObject
// {
// private:
