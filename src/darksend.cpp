...
{
    if(fLiteMode) return; // ignore all Versus related functionality
...
/*
    ...
    allow endless transaction that would bloat Versus and make it unusable. To
...
{
    if(fLiteMode) return; // disable all Versus specific functionality
    ...
    RenameThread("versus-privatesend");
